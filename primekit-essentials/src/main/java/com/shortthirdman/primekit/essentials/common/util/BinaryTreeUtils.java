...
import com.shortthirdman.primekit.essentials.common.CounterNode;
import com.shortthirdman.primekit.essentials.common.ListNode;
import com.shortthirdman.primekit.essentials.common.TreeNode;
...
public final class BinaryTreeUtils {
    ...
    public static List<List<Integer>> levelOrderTraversal(TreeNode root) {
        ...
        while (!nodeQueue.isEmpty()) {
            ...
            var levelValue = level != null ? level : 0;

            List<Integer> list;

            if (result.size() < levelValue) {
                list = new ArrayList<>();
                result.add(list);
            } else {
    ...
    public static TreeNode buildTree(int[] inorder, int inStart, int inEnd, int[] postorder, int postStart, int postEnd) throws Exception {
        ...
        TreeNode root = TreeNode.createTreeNode(rootValue);
    ...
    private static TreeNode buildTreeBottomUp(int start, int end) {
        ...
        TreeNode root = TreeNode.createTreeNode(h.getValue());
        h = h.getNext();
