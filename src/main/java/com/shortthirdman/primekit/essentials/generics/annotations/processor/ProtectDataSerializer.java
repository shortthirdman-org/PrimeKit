package com.shortthirdman.primekit.essentials.generics.annotations.processor;
...
import com.shortthirdman.primekit.essentials.generics.annotations.ProtectData;
...
public class ProtectDataSerializer extends StdSerializer<Object> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        Optional<ProtectData> annotation = Optional.ofNullable(beanProperty).map(prop -> prop.getAnnotation(ProtectData.class));
    ...
    public void serialize(Object value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        jsonGenerator.writeString(piiData);
    }
}
